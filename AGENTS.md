...
## Purpose
Public privacy-first text randomizer tool (`random.airat.top`).
...
## AI Working Notes
- Preserve parser syntax behavior (`{}`, `[]`, `%rand%`, escaping rules).
- Preserve output-format options (text/JSON/CSV) and uniqueness guarantees.
